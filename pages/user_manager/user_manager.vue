<template>
	<view class="template-about tn-safe-area-inset-bottom">
		<!-- <view class="top-backgroup" style="background-image: url('https://tnuiimage.tnkjapp.com/my/my-bg3.png')">
		...
		<view class="about__wrap " style="margin-top: 0rem;">
					...
					<view class="tn-padding-sm tn-margin-xs tn-radius">
						<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
							...
							<view class="tn-text-center">
								<text class="tn-text-ellipsis" @click="togoEsights()">乡村景点</text>
							</view>
						</view>
					</view>
					<view class="tn-padding-sm tn-margin-xs tn-radius">
						<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
							...
							<view class="tn-text-center">
								<text class="tn-text-ellipsis" @click="togoEAgri()">农业活动</text>
							</view>
						</view>
					</view>
					<view class="tn-padding-sm tn-margin-xs tn-radius">
						<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
							...
							<view class="tn-text-center">
								<text class="tn-text-ellipsis" @click="togoEDyna()">乡村动态</text>
							</view>
						</view>
					</view>
					<view class="tn-padding-sm tn-margin-xs tn-radius">
						<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
							...
							<view class="tn-text-center">
								<text class="tn-text-ellipsis" @click="togoEempl()">乡村就业</text>
							</view>
						</view>
					</view>
				</view>
				...
				<view class="tn-flex tn-flex-row-center tn-radius">
					<view class="tn-padding-sm tn-margin-xs tn-radius">
						<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
							...
							<view class="tn-text-center">
								<text class="tn-text-ellipsis" @click="gotoDsight()">乡村景点</text>
							</view>
						</view>
					</view>
					<view class="tn-padding-sm tn-margin-xs tn-radius">
						<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
							...
							<view class="tn-text-center">
								<text class="tn-text-ellipsis" @click="gotoDagri()">农业活动</text>
							</view>
						</view>
					</view>
					<view class="tn-padding-sm tn-margin-xs tn-radius">
						<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
							...
							<view class="tn-text-center">
								<text class="tn-text-ellipsis" @click="gotoDdyna()">乡村动态</text>
							</view>
						</view>
					</view>
					<view class="tn-padding-sm tn-margin-xs tn-radius">
						<view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
							...
							<view class="tn-text-center">
								<text class="tn-text-ellipsis" @click="gotoDempl()">乡村就业</text>
							</view>
						</view>
					</view>
				</view>
			...
			<!-- 更多信息-->
			<view class="about-shadow tn-margin-top tn-padding-top-sm tn-padding-bottom-sm">
				<tn-scroll-list :indicatorWidth="100" :indicatorBarWidth="30" indicatorColor="#FFE2D9"
