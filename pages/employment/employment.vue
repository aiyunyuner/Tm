				...
				<view class="article-shadow tn-margin">
					<view class="tn-flex">
						<view class="tn-margin-sm tn-padding-top-xs" style="width: 100%;">
							<view class="tn-text-lg tn-text-bold clamp-text-2 tn-text-justify"
								style="min-height: 95rpx;">
	...
	export default {
		...
		onShow() {
			...
			const requestTask = uni.request({
				url: 'http://www.rural.abc/employment/more', //仅为示例，并非真实接口地址。
				//仅为示例，并非真实接口地址。
				method: 'POST',
				data: {
		...
		methods: {
			...
			goSightsPages(e) {
				uni.navigateTo({
					url: `/pages/infor_empl/infor_empl?sid=${e}`
				});
			}
		}
	}
